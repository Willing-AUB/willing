...
function Card({
  ...
  return (
    ...
    <div className={`card h-full flex flex-col bg-base-100 shadow-md border border-base-300 ${className}`.trim()}>
      <div className={`card-body flex-1 flex flex-col ${padding ? '' : 'p-0'}`}>
        {title && (
