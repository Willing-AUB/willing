      ...
      <div key={step.id} className="mb-10">
        <div className="lg:grid lg:grid-cols-12 lg:items-center">
          ...
          <div className="lg:col-span-2 flex justify-center items-center relative">
            ...
            <div className="relative z-10 bg-gradient-to-br from-primary to-secondary rounded-full p-3 shadow-lg text-white">
              <SideIcon size={20} />
            </div>
          </div>
    ...
    <PageContainer>
      ...
      <div className="flex w-full gap-6">
        ...
        <main className="grow">
          ...
          <section id="overview" className="py-20 bg-base-200 rounded-3xl p-6 lg:p-10 mb-10">
            <h2 className="text-3xl font-black mb-6 bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent">Platform Overview — What Is Willing?</h2>
          ...
          <section id="volunteers" className="py-20 bg-base-100 rounded-3xl p-6 lg:p-10 mb-10">
            <h2 className="text-3xl font-black mb-8 bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent">Volunteer Journey</h2>
          ...
          <section id="organizations" className="py-20 bg-base-100 rounded-3xl p-6 lg:p-10 mb-10">
            <h2 className="text-3xl font-black mb-8 bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent">Organization Journey</h2>
            <div className="card bg-base-100 border border-base-300 shadow-sm p-6">
              <div className="relative">
                <div className="hidden lg:block absolute left-1/2 top-0 bottom-0 border-l-2 border-dashed border-primary-focus" />
                <div className="flex flex-col lg:space-y-0">
          ...
          <section id="crises" className="py-20 bg-base-200 rounded-3xl p-6 lg:p-10 mb-10">
            <div className="mb-6">
              <h2 className="text-3xl font-black bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent">Crisis Events: Real situations, urgent action</h2>
            </div>
          ...
          <section id="certificates" className="py-20 bg-base-100 rounded-3xl p-6 lg:p-10 mb-10">
            <div className="mb-6">
              <h2 className="text-3xl font-black bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent">Verified Certificates of Participation</h2>
            </div>
          ...
          <section id="faq" className="py-20 bg-base-200 rounded-3xl p-6 lg:p-10 mb-10">
            <h2 className="text-3xl font-black mb-6 bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent">Frequently Asked Questions</h2>
