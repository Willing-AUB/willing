...
import { type Database, newPlatformCertificateSettingsSchema } from '../../../db/tables/index.ts';
...
function createAdminCertificateSettingsRouter(db: Kysely<Database>) {
  ...
  return certificateSettingsRouter;
}

export default createAdminCertificateSettingsRouter;
